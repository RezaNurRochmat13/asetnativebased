                    ...
                    <div class="span12">
                        <div class="box">
                            <header>
                                ...
                                <h5>Laporan Data Inventaris dan Aset</h5>					  
                            </header>
								...
								<ul class="breadcrumb">
									...
									<div class="accordion-group">
                                        <table class="tableluar" border="0" width="940px">
                                         <tr>
                                            <form action="cetak_kategori_all.php" method="post">
									...
									<div class="modal-body" style="max-width:100%">
										<a href="print.php?print=cetak_kategori_all_priview" target="_blank"><button class="btn"><img src="images/cetak.png"> Cetak</button></a>
										<a href="export/export_all.php"><button class="btn"><img src="images/button-excel.gif"> Export</button></a><br>
										<table class="table table-bordered table-condensed table-hover table-striped" style="width:1200px">
                                            ...
                                            <tbody>
												...
												WHERE status like '%$_POST[cari_status]%' and p_i_C like '%$_POST[pic]%' ");
