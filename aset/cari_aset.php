                    ...
                    <div class="span12">
                        <div class="box">
                            <header>
                                ...
                                <h5 style="weight:bold">Data Inventaris dan Aset</h5>
                            </header>
                            <div id="collapse4" class="body">
									<ul class="breadcrumb">
										<li><a href="menu.php">Home</a> <span class="divider"><i class="icon-chevron-right"></i></span></li>
										<li><a href="tampil_aset.php?page=1">List Data</a> <span class="divider"><i class="icon-chevron-right"></i></span></li>
									...
									<div class="modal-body" style="max-width:100%">
										...
										<tr>
											...
											<td ><input type="text" name="cari_jml" id="cari_jml" label="Cari nama aset..."></td>
										...
										<table id="" class="table table-bordered table-condensed table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $tampil = mysql_query("SELECT * FROM barang b LEFT JOIN kategori k ON  b.id_kategori = k.id_kategori
												   where b.nama_barang like '%$txtcari%' order by b.id_aset ASC");
									...
									<table class="tableluar breadcrumb" style="width:100%">
										<tr>
											...
											<?php
											$sql="select * from barang where nama_barang like '%$_POST[cari_jml]%'";
